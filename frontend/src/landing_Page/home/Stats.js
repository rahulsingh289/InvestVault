        ...
        <div className='container p-3'>
            ...
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'> That's why 1.3+ crore customers trust InvestVault with
                    ...
                    <h2 className='fs-4'>The InvestVault universe</h2>
                ...
                <div className='col-6'>
                    <img src='media/images/ecosystem.png' alt='ecosyetem' style={{ width: "90%" }} />
